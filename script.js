...
Object.assign(translations.uk, {
  'Il ritmo giusto': 'Правильний ритм', 'Fuori è': 'Зовні', 'ancora più bello.': 'ще краще.', 'Leggi le recensioni su Airbnb': 'Переглянути відгуки на Airbnb',
  '01 — La casa': '01 — Будинок', '03 — Tutto il necessario': '03 — Усе необхідне', '03 — Il ritmo giusto': '03 — Правильний ритм', '04 — Dicono di noi': '04 — Відгуки гостей', '04 — Nei dintorni': '04 — Поруч', '05 — Il mare della Versilia': '05 — Море Версілії', '06 — Una storia da vedere': '06 — Історія, яку варто відкрити', '07 — Contatti': '07 — Контакти', '08 — Come arrivare': '08 — Як дістатися', '06 — Il tuo soggiorno': '06 — Ваш відпочинок',
  'Casa I Tre Ulivi nasce per chi cerca spazio, luce e la semplicità delle cose fatte bene.': 'Casa I Tre Ulivi створена для тих, хто шукає простір, світло та простоту добре продуманих речей.', "Qui le mattine iniziano con il sole sulle pareti e finiscono all'aperto, tra una cena lenta e il profilo degli alberi. Una base quieta per scoprire il paesaggio, o per non fare assolutamente nulla.": 'Тут ранок починається із сонця на стінах, а вечір завершується просто неба, за неквапливою вечерею та силуетами дерев. Тихе місце, щоб пізнавати краєвид або просто нічого не робити.', 'Vedi l\'annuncio completo': 'Переглянути повне оголошення',
  'Grande spazio all\'aperto': 'Великий відкритий простір', 'Posto auto coperto': 'Крите паркувальне місце', 'Posti auto all\'aperto': 'Відкриті паркувальні місця', 'Tranquillità': 'Спокій',
  'Riscaldamento e aria condizionata': 'Опалення та кондиціонер', 'Biancheria da letto inclusa': 'Постільна білизна включена', 'Connessione per restare connessi': 'Зв’язок, щоб залишатися на зв’язку', 'Zona pranzo e servizi di base': 'Обідня зона та все необхідне для приготування їжі', 'Lavatrice, asciugatrice e asciugacapelli': 'Пральна машина, сушарка та фен', "Spazi all'aperto": 'Відкриті простори', 'Per pranzi e cene all\'aperto': 'Для обідів і вечерь просто неба', 'Per una cucina sempre in ordine': 'Для охайної кухні', 'Dotazione di sicurezza': 'Засоби безпеки', 'Per una maggiore sicurezza': 'Для додаткової безпеки', 'Posto auto in loco e in strada': 'Паркування на території та на вулиці', 'Per i momenti di pausa': 'Для моментів відпочинку', 'Vedi tutti i servizi su Airbnb': 'Переглянути всі зручності на Airbnb',
  'Dalla casa si parte per passeggiate, borghi e tavole apparecchiate. Il resto lo decide la giornata.': 'Від будинку можна вирушити на прогулянку, до старовинних містечок або за стіл із готовою вечерею. Решту вирішить день.', 'Colazioni all\'aperto': 'Сніданки просто неба', 'Sentieri tra gli ulivi': 'Стежки серед оливкових дерев', 'Tramonti senza programmi': 'Заходи сонця без планів',
  '26 valutazioni verificate su Airbnb': '26 перевірених оцінок на Airbnb', '5 stelle': '5 зірок', '4 stelle': '4 зірки', 'Una delle categorie più apprezzate dagli ospiti.': 'Одна з категорій, яку гості цінують найбільше.', 'Valutazione media degli ospiti su Airbnb.': 'Середня оцінка гостей на Airbnb.', 'Check-in': 'Заселення', 'Comunicazione': 'Комунікація', 'Pulizia': 'Чистота', 'Rapporto qualità-prezzo': 'Співвідношення ціни та якості',
  'A pochi passi dalla costa, il bianco delle Alpi Apuane disegna un paesaggio che non si dimentica.': 'За кілька кроків від узбережжя білі Апуанські Альпи створюють незабутній краєвид.', 'Una giornata può iniziare tra gli ulivi e finire con i piedi nella sabbia. La costa versiliese è lì, tra il blu del Tirreno e il bianco delle Apuane.': 'День може початися серед оливкових дерев і завершитися ногами в піску. Узбережжя Версілії лежить між синявою Тірренського моря та білими Апуанськими Альпами.', 'Il mare e le Alpi Apuane': 'Море та Апуанські Альпи', 'Riviera Apuana e mare della Versilia': 'Апуанське узбережжя та море Версілії', 'Pontile di Marina di Massa sul mare della Versilia': 'Пірс Марина-ді-Масса на узбережжі Версілії', 'Tramonto sulla spiaggia di Marina di Pietrasanta': 'Захід сонця на пляжі Марина-ді-П\'єтрасанта', 'Spiaggia di Marina di Pietrasanta in Versilia': 'Пляж Марина-ді-Пʼєтрасанта у Версілії',
...
function setLanguage(language) {
  ...
  const languageLabels = { en: 'Language', it: 'Lingua', de: 'Sprache', fr: 'Langue', es: 'Idioma', zh: '语言', uk: 'Мова' };
  ...
  document.querySelector('.language-switcher').style.setProperty('--language-label', JSON.stringify(languageLabels[language] || languageLabels.en));
